...
const ForkSvg = () => (
  <svg width='1em' height='1em' fill='currentColor' viewBox='0 0 640 640'>
...
const ForkFilled: React.FunctionComponent<Partial<CustomIconComponentProps>> = (
  props,
) => <Icon component={ForkSvg} {...props} />

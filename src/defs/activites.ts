...
const activites: Activite[] = [
  {
    ...
    data: {
      ...
      label: "Treignac Plage Restaurant",
      description: {
        fr: "Restaurant, bar, snack et glacier au bord de l'eau : une adresse lumineuse pour manger, trinquer et prolonger les belles journées au lac.",
        en: "Waterfront restaurant, bar, snack bar, and ice cream parlor: a bright, inviting spot to dine, have a drink, and make the most of beautiful days by the lake.",
        es: "Restaurante, bar, cafetería y heladería junto al agua: un lugar ideal para comer, beber y prolongar los hermosos días en el lago.",
      },
      img: "https://treignac-plage.fr/logo.jpg",
      link: "https://treignac-plage.fr/",
      facebook: "https://www.facebook.com/profile.php?id=61591464093241",
      instagram: "https://www.instagram.com/treignacplage/",
      maps: "https://maps.app.goo.gl/LRteRfAogNMe4Y4W8",
    },
  },
  {
    key: "commerce",
    data: {
      ...
      description: {
        fr: "Un café, une bière, quelque chose à grignoter, un match de rubgy, une soirée à thème, ... Il y a de tout au café du commerce.",
        en: "A coffee, a beer, something to nibble on, a rugby match, a themed evening… there is a bit of everything at the Café du Commerce.",
        es: "Un café, una cerveza, algo para picar, un partido de rugby, una noche temática… En el Café du Commerce hay de todo.",
      },
  ...
  },
  {
    ...
    data: {
      ...
      description: {
        fr: "Bar, tabac, FDJ",
        en: "Bar, tobacconist, lottery (FDJ)",
        es: "Bar, estanco, lotería (FDJ)",
      },
  ...
  },
  {
    ...
    data: {
      ...
      label: "Café de Paris",
      description: {
        fr: "Restauration 7jours/7 du midi au soir, Bar, PMU, Papeterie, Librarie / Maison de la presse",
        en: "Dining 7 days a week from midday to evening, bar, betting (PMU), stationery, bookshop / newsagent",
        es: "Restauración 7 días a la semana de mediodía a noche, bar, apuestas (PMU), papelería, librería / quiosco de prensa",
      },
  ...
  },
  {
    ...
    data: {
      ...
      description: {
        fr: "Plage, restaurant, pédalo, canoë/kayak, jeux pour enfants, ...",
        en: "Beach, restaurant, pedal boats, canoe/kayak, children’s playground…",
        es: "Playa, restaurante, hidropedales, canoa/kayak, juegos para niños…",
      },
  ...
  },
  {
    ...
    data: {
      ...
      description: {
        fr: "Vous trouverez dans la boutique tous les produits d'une épicerie classique, avec un maximum de produits locaux : viandes locales, fromages, pain, vins, bières locales, kéfirs et pétillants, truite de la Vézère, fruits et légumes, savons, etc...",
        en: "In the shop you will find all the products of a classic grocery store, with as many local products as possible: local meats, cheeses, bread, wines, local beers, kefirs and sparkling drinks, Vézère trout, fruits and vegetables, soaps, etc.",
        es: "En la tienda encontrarás todos los productos de una tienda de comestibles clásica, con el máximo de productos locales: carnes locales, quesos, pan, vinos, cervezas locales, kéfir y bebidas espumosas, trucha del Vézère, frutas y verduras, jabones, etc.",
      },
  ...
  },
  {
    ...
    data: {
      ...
      description: {
        fr: "Meilleure boulangerie de Treignac",
        en: "The best bakery in Treignac",
        es: "La mejor panadería de Treignac",
      },
  ...
  },
  {
    ...
    data: {
      ...
      description: {
        fr: "Très belle cascade au milieu de la forêt. Randonnée de niveau intermédiaire, sentiers escarpés, pente forte, ne pas faire avec des enfants en bas âge.",
        en: "A beautiful waterfall in the middle of the forest. Intermediate-level hike, steep paths, strong slope, not suitable for young children.",
        es: "Una cascada preciosa en medio del bosque. Excursión de nivel intermedio, senderos escarpados, fuerte pendiente, no apta para niños pequeños.",
      },
  ...
  },
  {
    ...
    data: {
      ...
      description: {
        fr: "Pâtisserie-Chocolaterie",
        en: "Pastry and chocolate shop",
        es: "Pastelería y chocolatería",
      },
  ...
  },
  {
    ...
    data: {
      ...
      description: {
        fr: "Boucherie-Charcuterie-Traiteur",
        en: "Butcher, deli & caterer",
        es: "Carnicería, charcutería y catering",
      },
  ...
  },
  {
    ...
    data: {
      ...
      description: {
        fr: "Magasin d'art de la table",
        en: "Tableware shop",
        es: "Tienda de artículos de mesa",
      },
  ...
  },
  {
    ...
    data: {
      ...
      description: {
        fr: "Prêt à porter féminin",
        en: "Women’s ready-to-wear",
        es: "Moda femenina",
      },
  ...
  },
  {
    ...
    data: {
      ...
      description: {
        fr: "Café, soirées à thèmes, ...",
        en: "Café, themed evenings…",
        es: "Café, noches temáticas…",
      },
  ...
  },
  {
    ...
    data: {
      ...
      description: {
        fr: "Art afghan. Tapis, sac, écharpe ...",
        en: "Afghan art. Rugs, bags, scarves…",
        es: "Arte afgano. Alfombras, bolsos, bufandas…",
      },
  ...
  },
  {
    ...
    data: {
      ...
      description: {
        fr: "Sellier harnacheur, réparation et création d'articles en cuir, sellerie motos custom et confort.",
        en: "Saddler and harness maker, repair and creation of leather goods, custom and comfort motorcycle saddlery.",
        es: "Guarnicionero, reparación y creación de artículos de cuero, tapicería para motos custom y de confort.",
      },
  ...
  },
  {
    ...
    data: {
      ...
      description: {
        fr: "Création de vêtements et accessoires bébés, enfants et femmes en vente directe et à la demande. Retouches et création, mode et intérieur. Déplacement à domicile possible, sur rendez-vous uniquement.",
        en: "Creation of clothing and accessories for babies, children and women, sold directly and made to order. Alterations and creation, fashion and home. Home visits possible, by appointment only.",
        es: "Creación de ropa y accesorios para bebés, niños y mujeres, en venta directa y a medida. Arreglos y creación, moda y hogar. Visitas a domicilio posibles, solo con cita previa.",
      },
  ...
  },
  {
    ...
    data: {
      ...
      label: "Le Bellevue",
      description: {
        fr: "Salon de thé. Spécialités culinaires, cuisine japonaise/sushi, pâtisseries.",
        en: "Tea room. Culinary specialities, Japanese cuisine/sushi, pastries.",
        es: "Salón de té. Especialidades culinarias, cocina japonesa/sushi, pastelería.",
      },
  ...
  },
  {
    ...
    data: {
      ...
      label: "Le Nat’elier",
      description: {
        fr: "Retouches, ourlets, fermetures, rideaux. Réparations doudous. Créations accessoires, sacs, pochettes ...",
        en: "Alterations, hems, zips, curtains. Soft-toy repairs. Creation of accessories, bags, pouches…",
        es: "Arreglos, dobladillos, cremalleras, cortinas. Reparación de peluches. Creación de accesorios, bolsos, estuches…",
      },
